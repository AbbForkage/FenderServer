...
var commands = exports.commands = {
	...
	dexsearch: function (target, room, user) {
		...
		var searches = {};
		var allTiers = {'uber':1, 'ou':1, 'uu':1, 'lc':1, 'cap':1, 'bl':1, 'bl2':1, 'ru':1, 'bl3':1, 'nu':1, 'lcou':1, 'lcuu':1};
	...
	groups: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			"% <b>Driver</b> - The above, and they can mute. They can also lock users and check for alts<br />" +
			"@ <b>Moderator</b> - The above, and they can ban users. They can also use /imgdeclare and control tournaments.<br />" +
			"&amp; <b>Leader</b> - The above, and they can promote to moderator and force ties<br />" +
			"~ <b>Administrator</b> - They can do anything. ANYTHING. <br />" +
